...
function App() {
  ...
  async function handleSubmit(e) {
    ...
    if (conversationId === "") {
      ...
      try {
        const response = await axios.post("http://localhost:8000/queries", requestData);
        console.log("Response from /queries:", response.data);
        ...
        setChatLog([...chatlog,{ user: "me", message: `${input}` },  newMessage]);
  
        setInput(""); 
      } catch (error) {
        console.error("Error making /queries request:", error);
      }
    }
  }
  ...
  return (
    ...
    <div className="chat-input-holder"> 
      <form onSubmit={handleSubmit}>
        ...
        className="chat-input-area" placeholder="Type your message here">
        </input>
      </form>
    </div>
    </section>
